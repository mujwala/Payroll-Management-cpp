...
void loginFrame1(int xLenS = 18, int yLenS = 8, int xLenE = 55,
int yLenE = 15)
{
system("cls");
...
void borderNoDelay(int xLenS = 2,int yLenS = 2,int xLenE =
76,int yLenE = 24
)
...
void border(int xLenS = 2, int yLenS = 2,int xLenE = 76, int
yLenE = 22 )
{
system("cls");
gotoXY(xLenS,yLenS);printf("%c",201);
...
void loginFrame(int xLenS = 18,int yLenS = 8,int xLenE = 55,int
yLenE = 15)
{
...
int i=num;
int
sal,PF,TAX,HRA,MealA,MedicalA,TransportA,LoanBal,LoanDeb,h,DA;
char loan;
num+=1;
gotoXY(28,4);
cout<<"Insert New Record of employee";
gotoXY(10,6);
cout<<"Name of the employee : ";
cin>>emp[i].name;
gotoXY(10,8);
cout<<"Code of the employee: ";
cin>>emp[i].code;
gotoXY(10,10);
cout<<"Designation : ";
...
emp[i].grosspay = (sal+MealA+MedicalA+TransportA+HRA+DA)-
(PF+TAX+LoanDeb) ;
getch();
}
void intro()
{
gotoXY(27,4); cout<<"PAYROLL MANAGEMENT SYSTEM";
...
borderNoDelay();
gotoXY(16,4);
cout<<"***** SRM PAYROLL MANAGEMENT SYSTEM ***** ";
gotoXY(12,6);
...
borderNoDelay();
gotoXY(28,4);
cout<<"Modify the employee record";
gotoXY(10,6);
...
{
int
sal,PF,TAX,HRA,MealA,MedicalA,TransportA,LoanBal=emp[i].LoanBalance,LoanDeb,DA;
char loan;
gotoXY(10,18);
